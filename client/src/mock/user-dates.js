...
export const addUserSchema = yup.object().shape({
  ...
  birthDate: yup
    ...
    .matches(
      ...
      `Ma'lumot shu ko'rinishda bo'lishi kerak YYYY-MM-DD`
    ),
  username: yup.string().trim().required("Username ni kiriting"),
  password: yup
    .string()
    .min(4, "Parol kamida 4 sondan iborat bo'lishi kerak")
    .required(),
  userRole: yup
    .string()
